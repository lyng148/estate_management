...
public class BuildingController {
    ...
    public ModelAndView buildingList(@ModelAttribute(name = "modelSearch") BuildingSearchRequest buildingSearchRequest, @ModelAttribute(SystemConstant.MODEL) BuildingSearchResponse model, HttpServletRequest request) {
