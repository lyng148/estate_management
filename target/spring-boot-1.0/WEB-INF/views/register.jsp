                                        ...
                                        <div class="row d-flex justify-content-center align-items-center h-100">
                                            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                                                <div class="card text-white"
                                                    ...
                                                    <form action="/api/user/register " id="regForm" method="post">
                                                        <div class="card-body p-2 px-5 text-center">
                                                            <div class="md-5 md-4 mt-4 pb-2">
                                                                ...
                                                                <div class="form-outline form-white mb-2">
                                                                    <label class="form-label"
                                                                           for="typeEmailX2">Password</label>
                                                                    <input type="password" id="typeEmailX2"
                                                                           class="form-control form-control-lg"
                                                                           name="password"/>
                                                                </div>

                                                                <div class="form-outline form-white mb-2">
                                                                    <label class="form-label" for="typeEmailX1">Repeat
                                                                        your
                                                                        password</label>
                                                                    <input type="password" id="typeEmailX1"
                                                                           class="form-control form-control-lg"
                                                                           name="repeatPassword"/>
                                                                </div>
                                                                ...
                                                                <button class="btn btn-outline-light btn-lg px-5"
                                                                        type="button" id="btn-reg">Register
                                                                </button>
                                                                ...
                                                                <p class="text-center text-muted mt-2 mb-0">Have already
                                                                    an
                                                                    account? <a href="#!"
                                                                                class="fw-bold text-body"><u
                                                                            style="color: white ;">Login here</u></a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </form>
